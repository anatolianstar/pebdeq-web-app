...
export const THEME_TEMPLATE = {
  ...
  colors: {
    ...
    // ========== ADMIN SETTINGS COLORS - EXACT MAPPING ==========
    ...
    mobile_nav_hamburger_color: '#212529',
    ...
    // Homepage Products 2 Colors
    homepage_products2_product_name_color: '#007bff',
    homepage_products2_product_price_color: '#28a745',
    homepage_products2_product_category_color: '#6c757d',
    ...
    product_detail_product_details_label_color: '#6c757d',
    product_detail_product_details_value_color: '#212529',
    
    // ========== LEGACY COMPONENT COLORS (kept for compatibility) ==========
  ...
  // Typography
  typography: {
    // ========== ADMIN SETTINGS FONTS - EXACT MAPPING ==========
    
    // Navigation Fonts
    nav_link_font_size: 16,
    nav_link_font_weight: '500',
    nav_link_font_family: 'inherit',
